...
not reasonable, better stay to the same place! So the task is t
o give to the man a simplified version of the plan. A better plan in this case is simply:
...
opposite after the reduction of "EAST" and "WEST" so
